...
<form action="adminpage_date_result.php" method="get">
  <label>Introduceti data de inceput</label>
<input type="date" name="inceput">
<label>Introduceti data de sfarsit</label>
<input type="date"name ="sfarsit">

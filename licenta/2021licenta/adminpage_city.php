...
<div><form>
<div class= "container">
<h3>Orașele cu cea mai mare putere de cumpărare</h3>
<table>
<tr>
<td><b>Orașe</b></td>
<td><b>Numărul de comenzi<b></td>
</tr>
<?php
$records=mysqli_query($conn,"SELECT COUNT(city) AS countc, city FROM orders GROUP BY city ORDER BY countc DESC LIMIT 3");
while ($data=mysqli_fetch_array($records))
{
      ?>
      <tr>
        <td><?php echo $data['city']; ?></td>
        <td><?php echo $data['countc']; ?></td>
      <tr>
      <?php
}
?>

...
<table border="1">
  ...
  while($data=mysqli_fetch_array($records))
  {
      ...
      <tr>
        ...
        <td><?php echo $data['usersDate']; ?></td>
        <td><a href="edit.php?id=<?php echo $data['usersId']; ?>">Editează</a></td>
        <td><a href="delete.php?id=<?php echo $data['usersId']; ?>">Șterge</a></td>
     </tr>
     <?php
  }
  ?>
